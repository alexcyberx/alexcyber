...
function showPage(page, skipPush) {
  ...
  const PAGE_META = {
    home:        { title: 'AlexCyberX: Free Cybersecurity Education for Everyone', desc: 'AlexCyberX is a free cybersecurity education platform by Pavan Kumar, a Certified Ethical Hacker from Rajasthan, India. Learn Ethical Hacking, Network Forensics, and Cyber Attack techniques in Hindi with hands-on CTF labs.' },
