...
const CTF_OVERRIDES = {
  'web-01': {
    en: {
      ...
      scenario: 'A security audit flagged <strong>CorpX Ltd.</strong> for a potential data exposure. Their internal employee portal was pushed to production without a final cleanup pass. The dev team insists there is nothing sensitive on the surface. And they are right. The page renders clean.<br><br>Your job is to go deeper. Developers leave traces everywhere: in markup they assumed no one reads, in endpoints they assumed no one visits, in scripts they assumed no one inspects. The flag was accidentally fragmented across three of these locations during a rushed deployment.<br><br>Not everything that matters is visible in the browser. Some of it lives in the infrastructure around the page.<br><br><span style="font-family:\'Courier New\',monospace;font-size:11px;color:#3a3a5a;">target: corpx-portal-v2.4.1 | classification: internal | status: live</span>'
    },
    hi: {
      ...
      scenario: 'एक security audit में <strong>CorpX Ltd.</strong> का internal employee portal flag हुआ। production push से पहले final cleanup नहीं हुई। dev team का कहना है कि surface पर कुछ भी sensitive नहीं है। वो सही भी हैं। page बिल्कुल clean render होता है।<br><br>तुम्हारा काम है deeper जाना। developers हर जगह traces छोड़ते हैं: उस markup में जो उन्हें लगा कोई नहीं पढ़ेगा, उन endpoints पर जो उन्हें लगा कोई नहीं जाएगा, उन scripts में जो उन्हें लगा कोई नहीं देखेगा। एक rushed deployment में flag तीन अलग locations में accidentally fragment हो गया।<br><br>जो browser में दिखता है, वो सब नहीं है। कुछ page के आसपास के infrastructure में छिपा है।<br><br><span style="font-family:\'Courier New\',monospace;font-size:11px;color:#3a3a5a;">target: corpx-portal-v2.4.1 | classification: internal | status: live</span>'
    },
    pa: {
      ...
      scenario: 'ਇੱਕ security audit ਵਿੱਚ <strong>CorpX Ltd.</strong> ਦਾ internal employee portal flag ਹੋਇਆ। production push ਤੋਂ ਪਹਿਲਾਂ final cleanup ਨਹੀਂ ਹੋਈ। dev team ਕਹਿੰਦੀ ਹੈ surface ਤੇ ਕੁਝ ਵੀ sensitive ਨਹੀਂ। ਉਹ ਸਹੀ ਵੀ ਹਨ। page ਬਿਲਕੁਲ clean render ਹੁੰਦਾ ਹੈ।<br><br>ਤੁਹਾਡਾ ਕੰਮ ਹੈ deeper ਜਾਣਾ। developers ਹਰ ਜਗ੍ਹਾ traces ਛੱਡਦੇ ਹਨ: ਉਸ markup ਵਿੱਚ ਜੋ ਉਨ੍ਹਾਂ ਨੂੰ ਲੱਗਿਆ ਕੋਈ ਨਹੀਂ ਪੜ੍ਹੇਗਾ, ਉਨ੍ਹਾਂ endpoints ਤੇ ਜੋ ਉਨ੍ਹਾਂ ਨੂੰ ਲੱਗਿਆ ਕੋਈ ਨਹੀਂ ਜਾਵੇਗਾ, ਉਨ੍ਹਾਂ scripts ਵਿੱਚ ਜੋ ਉਨ੍ਹਾਂ ਨੂੰ ਲੱਗਿਆ ਕੋਈ ਨਹੀਂ ਦੇਖੇਗਾ। ਇੱਕ rushed deployment ਵਿੱਚ flag ਤਿੰਨ ਵੱਖ locations ਵਿੱਚ accidentally fragment ਹੋ ਗਿਆ।<br><br>ਜੋ browser ਵਿੱਚ ਦਿਖਦਾ ਹੈ, ਉਹ ਸਭ ਨਹੀਂ ਹੈ। ਕੁਝ page ਦੇ ਆਲੇ-ਦੁਆਲੇ ਦੇ infrastructure ਵਿੱਚ ਛੁਪਿਆ ਹੈ।<br><br><span style="font-family:\'Courier New\',monospace;font-size:11px;color:#3a3a5a;">target: corpx-portal-v2.4.1 | classification: internal | status: live</span>'
    },
    ta: {
      ...
      scenario: 'ஒரு security audit-இல் <strong>CorpX Ltd.</strong>-இன் internal employee portal flag செய்யப்பட்டது. production-க்கு push செய்வதற்கு முன் final cleanup நடைபெறவில்லை. dev team சொல்கிறார்கள் surface-இல் எதுவும் sensitive இல்லை என்று. அவர்கள் சொல்வது சரிதான். page சுத்தமாக render ஆகிறது.<br><br>உங்கள் வேலை deeper போவது. developers எல்லா இடங்களிலும் traces விட்டுச் செல்கிறார்கள்: யாரும் படிக்க மாட்டார்கள் என்று நினைத்த markup-இல், யாரும் போக மாட்டார்கள் என்று நினைத்த endpoints-இல், யாரும் பார்க்க மாட்டார்கள் என்று நினைத்த scripts-இல். ஒரு rushed deployment-இல் flag மூன்று இடங்களில் accidentally fragment ஆனது.<br><br>browser-இல் தெரிவது எல்லாமில்லை. சிலது page-ஐ சுற்றியுள்ள infrastructure-இல் மறைந்துள்ளது.<br><br><span style="font-family:\'Courier New\',monospace;font-size:11px;color:#3a3a5a;">target: corpx-portal-v2.4.1 | classification: internal | status: live</span>'
    },
    te: {
      ...
      scenario: 'ఒక security audit లో <strong>CorpX Ltd.</strong> యొక్క internal employee portal flag అయింది. production కి push చేయడానికి ముందు final cleanup జరగలేదు. dev team చెప్తోంది surface మీద ఏమీ sensitive లేదని. అది నిజమే. page చాలా clean గా render అవుతుంది.<br><br>మీ పని deeper వెళ్ళడం. developers అన్ని చోట్లా traces వదులుతారు: ఎవరూ చదవరని అనుకున్న markup లో, ఎవరూ వెళ్ళరని అనుకున్న endpoints లో, ఎవరూ చూడరని అనుకున్న scripts లో. ఒక rushed deployment లో flag మూడు వేర్వేరు locations లో accidentally fragment అయింది.<br><br>browser లో కనిపించేది అన్నీ కాదు. కొంత page చుట్టూ ఉన్న infrastructure లో దాచి ఉంది.<br><br><span style="font-family:\'Courier New\',monospace;font-size:11px;color:#3a3a5a;">target: corpx-portal-v2.4.1 | classification: internal | status: live</span>'
    },
    bn: {
      ...
      scenario: 'একটি security audit-এ <strong>CorpX Ltd.</strong>-এর internal employee portal flag হয়েছে. production-এ push করার আগে final cleanup হয়নি। dev team বলছে surface-এ কিছুই sensitive নেই। তারা ঠিকই বলছে। page একদম clean render হয়।<br><br>তোমার কাজ deeper যাওয়া। developers সব জায়গায় traces রেখে যায়: যে markup কেউ পড়বে না ভেবেছিল সেখানে, যে endpoints-এ কেউ যাবে না ভেবেছিল সেখানে, যে scripts কেউ দেখবে না ভেবেছিল সেখানে। একটি rushed deployment-এ flag তিনটি আলাদা location-এ accidentally fragment হয়ে গেছে।<br><br>browser-এ যা দেখা যায় সেটাই সব না। কিছুটা page-এর চারপাশের infrastructure-এ লুকিয়ে আছে।<br><br><span style="font-family:\'Courier New\',monospace;font-size:11px;color:#3a3a5a;">target: corpx-portal-v2.4.1 | classification: internal | status: live</span>'
    },
    mr: {
      ...
      scenario: 'एका security audit मध्ये <strong>CorpX Ltd.</strong> चा internal employee portal flag झाला. production ला push करण्यापूर्वी final cleanup झाली नाही. dev team सांगते surface वर काहीही sensitive नाही. ते बरोबर आहे. page अगदी clean render होतो.<br><br>तुमचं काम आहे deeper जाणं. developers सर्वत्र traces सोडतात: ज्या markup मध्ये कोणी वाचणार नाही असं वाटलं तिथे, ज्या endpoints वर कोणी जाणार नाही असं वाटलं तिथे, ज्या scripts मध्ये कोणी पाहणार नाही असं वाटलं तिथे. एका rushed deployment मध्ये flag तीन वेगळ्या locations मध्ये accidentally fragment झाला.<br><br>browser मध्ये जे दिसतं ते सगळं नाही. काही page च्या आसपासच्या infrastructure मध्ये लपलेलं आहे.<br><br><span style="font-family:\'Courier New\',monospace;font-size:11px;color:#3a3a5a;">target: corpx-portal-v2.4.1 | classification: internal | status: live</span>'
    }
  },
  'web-02': {
    en: {
