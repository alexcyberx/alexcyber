  ...
  <div class="login-card">
    ...
    <div class="card-body">
      ...
      <div class="form-group">
        ...
        <input type="text" id="uname" value="alex" placeholder="Enter employee ID" autocomplete="off">
      </div>
      <div class="form-group">
...
router.post('/login', async (req, res) => {
  ...
  if (username === 'alex' && password === 'pass123') {
    logAttempt('SQLI101', req.ip, 'login:alex', 'ok');
...
<div class="topbar">
  ...
  <div class="user-row">
    <span class="user-chip">alex</span>
...
// FIX: Export instances so server/index.js cleanup interval can
// close expired sql.js Database objects and free memory.
